...
/**
 * Handles queries for repository methods annotated with {@link Query}.
 *
 * @author Mattias Hellborg Arthursson
 * @author Mark Paluch
 */
public class AnnotatedLdapClientRepositoryQuery extends AbstractLdapClientRepositoryQuery {
	 ...
	 * @param ldap the LdapClient instance to use.
